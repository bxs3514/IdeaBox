...
<link rel="stylesheet" href="/ideabox/common/css/error-message.css">
...
<body>
	...
	<form action="/ideabox/questionnaire/SummitAnswers.action" method="post">
		<s:property value="#request.outterHtml" escape="false" />
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<s:if test="#request.canAnswer != null && #request.canAnswer">
					<button class="btn btn-primary btn-block btn-large" type="summit">我已做完，提交！</button>
					</s:if>
				</div>
			</div>
		</div>
