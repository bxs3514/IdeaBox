	...
	<div class="navbar navbar-inverse" role="navigation">
		...
		<div class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="../login/logout.action">登出<s:property
		...
		<div class="row">
			<div class="col-md-2 sidebar">
				<ul class="nav nav-pills nav-stacked">
					<li><a href="../questionnaire/QuesTitle.jsp">创建问卷</a>
					<li><a
			...
			<div class="col-md-10 main">
				...
				<form class="form-horizontal" role="form" method='post'
					action='/ideabox/userdashboard/EditInformation.action?isView=true'>
					...
					<div class="form-group">
						...
						<div class="col-xs-4">
							<input type="text" class="form-control" id="username"
								...
								value='<s:property value="#request.username"/>'> <span><s:fielderror
									fieldName='username' /> </span>
						</div>
					</div>
					<div class="form-group">
						<label for="birthdate" class="col-xs-2">出生日期</label>
						<div class="col-xs-4">
							<input type="date" class="form-control" id="birthdate"
								placeholder="birthdate" name='birthdate'
								value='<s:property value="#request.birthdate"/>'> <span><s:fielderror
									fieldName='birthdate' /> </span>
						</div>
					</div>
					<input type="hidden"
						value="<s:property value='#session.user.gender'/>"/ >
						...
						<div class="col-xs-4">
							<div>
								<lable class="radio-inline"> <input type="radio"
									name="gender" value="female">女</lable>
								<lable class="radio-inline"> <input type="radio"
									name="gender" value="male">男</lable>
								<!--  <p><s:property value="#session.user.gender" /></p>-->
							</div>
							<span><s:fielderror fieldName='gender' /> </span>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-xs-4">
							<input type="password" class="form-control" id="passwordConfirm"
								placeholder="Password again" name='passwordConfirm'> <span><s:fielderror
									fieldName='passwordConfirm' /> </span>
						</div>
					</div>
					<p>
						<s:actionerror />
